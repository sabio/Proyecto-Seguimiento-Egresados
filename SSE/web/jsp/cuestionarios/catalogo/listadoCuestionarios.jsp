        ...
        <script type="text/javascript" charset="utf-8">
            ...
            */
            ...
            function eliminar(id){
                jConfirm('¿Desea eliminar el cuestionario? Será eliminado cualquier resultado asociado a éste cuestionario', 'Confirmacion', function(r) {
                    if(r){
                    ...
                    <table id="tablaCatalogo" class="display">
                        ...
                        <tbody>
                            <c:forEach  items="${listadoCuestionarios}" var="cuestionario">
                                <tr>
                                    <td>
                                        <a href="edicionCuestionario.run?idCuestionario=${cuestionario.idCuestionario}">
